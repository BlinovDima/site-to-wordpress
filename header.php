                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:<?php echo the_field('mail')?>" class="header__contacts-mail"><?php the_field('mail',2);?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:<?php echo the_field('telefon_1')?>">
                                        <?php the_field('telefon_1',2);?>
                                    </a>
                                    
                                    <a href="tel:<?php echo the_field('telefon_2')?>">
                                        <?php the_field('telefon_2',2);?>
                                    </a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo bloginfo('template_url');?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                                <address><?php the_field('adr_street',2);?><br>
                                <?php the_field('adr_city_country_index',2);?></address>
                            </div>
                        </div>
                    </div>
                </div>
